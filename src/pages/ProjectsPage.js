...
const projects = [
  {
    ...
    keywords: ['Python', 'Machine Learning', 'Exploratory Data Analysis', 'Preprocessing', 'Linear Regression', 'Decision Tree Regression', 'Gradient Boosting Regression', 'XGBoost Regression'],
